...
const getEmailText = (firstName: string, url: string) => {
...
const getEmailHTML = (firstName: string, url: string) => {
  return `
...
export function getChangePasswordEmail(props: GetEmailProps) {
  return {
    ...
    text: getEmailText(props.firstName, props.url),
    html: getEmailHTML(props.firstName, props.url),
  };
}
